...
function Modelo(){
    ...
    this.savePicture = ({imageToSave,userName},callback)=>{
        const fs = require('fs');
        let h64 = 'data:image/jpeg;base64,';
        let base64Data = imageToSave.substring(h64.length);
        let me = this;
        require("fs").writeFile(`./uploads/${userName}.jpg`, base64Data, 'base64', function(err) {
            ...
            callback({ok:(err==null),msg:response})
        });
